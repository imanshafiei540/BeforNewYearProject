...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolBar.setIconSize(QtCore.QSize(58, 60))
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/Project/BeforNewYearProject/history.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionHistory.setIcon(icon11)
        ...
        QtCore.QObject.connect(self.actionCopy, QtCore.SIGNAL(_fromUtf8("triggered()")), self.treeView.reset)
